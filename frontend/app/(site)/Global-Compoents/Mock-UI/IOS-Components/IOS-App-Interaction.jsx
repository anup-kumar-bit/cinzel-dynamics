  ...
  if (screens.length === 0) {
    return (
      <div className="ios-wake-in absolute inset-0 flex flex-col items-center justify-center gap-3 bg-neutral-900 px-6 text-center">
        ...
        {/* The gesture bar alone is too small to read as a way out of a dead end. */}
        <button
          type="button"
          onClick={onClose}
          className="font-opensans mt-1 flex cursor-pointer items-center gap-1 rounded-full bg-white/15 px-3 py-1.5 text-[10px] font-semibold text-white transition hover:bg-white/25 active:scale-95"
        >
